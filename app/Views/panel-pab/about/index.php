            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="com-pro" role="tabpanel">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-4 p-3 border rounded bg-light">
                            <label class="form-label fw-bold">Opsi 2: Link Google Drive / External</label>
                            <input type="text" name="compro_link" class="form-control"
                                placeholder="https://drive.google.com/..."
                                value="<?= $compro_link ?? ''; ?>">
                            <div class="form-text text-primary">
                                <i class="fas fa-info-circle"></i> <strong>Tips:</strong> Jika kolom ini diisi, tombol download akan otomatis mengarah ke link ini (File lokal akan diabaikan).
                            </div>
                        </div>
                    </div>
                </div>
