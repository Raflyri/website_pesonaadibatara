                    ...
                    <tbody>
                        <?php foreach ($vacancies as $job) : ?>
                            <tr>
                                ...
                                <td>
                                    <a href="/panel-pab/job-vacancies/edit/<?= esc($job['id']); ?>" class="btn btn-sm btn-info text-white">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="/panel-pab/job-vacancies/delete/<?= esc($job['id']); ?>" method="post" class="d-inline" onsubmit="return confirm('Apakah Anda yakin ingin menghapus lowongan ini?')">
                                        <?= csrf_field(); ?>
